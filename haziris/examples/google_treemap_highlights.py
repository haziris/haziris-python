...
df = pd.DataFrame([
      ['Shakespeare', np.nan, 0],

      ['Comedies', 'Shakespeare', np.nan],
      ['Tragedies', 'Shakespeare', np.nan],
      ['Histories', 'Shakespeare', np.nan],

      ['As You Like It', 'Comedies', np.nan],
      ...
      ['Comedy Of Errors', 'Comedies', np.nan],
      ...
      ['Merchant Of Venice', 'Comedies', np.nan],
      ...
      ['Midsummer Nights Dream', 'Comedies', np.nan],
      ...
      ['Taming Of The Shrew', 'Comedies', np.nan],
      ...
      ['History Of King John', 'Histories', np.nan],
      ...
      ['Antony And Cleopatra', 'Tragedies', np.nan],
      ...
      ['The Tragedy of Hamlet, Prince of Denmark', 'Tragedies', np.nan],
      ...
      ['Julius Caesar', 'Tragedies', np.nan],
      ...
      ['The Tragedy Of Macbeth', 'Tragedies', np.nan],
      ...
      ['The Tragedy Of Othello', 'Tragedies', np.nan],
      ...
      ['Romeo And Juliet', 'Tragedies', np.nan],
  ...
  columns = ['ID', 'Parent', 'Number Of Lines' ]
)
